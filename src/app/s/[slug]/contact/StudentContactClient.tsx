...
export default function StudentContactClient({ student }: Props) {
  ...
  return (
    <>
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-4">
          <h1 className="text-center font-heading text-4xl font-bold text-navy">
            Contact {student.displayName}
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-center text-lg text-ink/70">
            Fill in the form below for a free, no-obligation cash offer.
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-[12px] border border-green bg-green/5 px-6 py-3 font-heading text-sm font-bold text-green hover:bg-green/10"
            >
      ...
      <section className="border-t border-border-grey bg-white py-12">
